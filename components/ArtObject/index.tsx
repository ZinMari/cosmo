            ...
            <div className={styles.artObjectContainer}>
                <div className={styles.artObjectColumn}>
                    <div className={cl(styles.artObjectRow, styles.artObjectTextSpace)}>
                        <h3>How many ?</h3>
                        <p>Our genesis land NFT collection will comprise<br/><strong className={styles.artObjectTextLarge}>5555 NFTs.</strong></p>
                    </div>
                ...
                <div className={styles.artObjectColumn}>
                    ...
                    <div className={cl(styles.artObjectRow, styles.artObjectDuo)}>
                        <div>
