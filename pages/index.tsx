...
export default function Home() {
  return (
    <article>
      ...
      <section className={cl(styles.section, styles.sectionQuestions)}>
        <div className={styles.sectionContent}>
          <ArtTitle type='down' className={styles.artTitle}>FAQ</ArtTitle>
          <Title size='Small' className={styles.subTitle}>
            HAVE 
            <svg className={styles.questionStar} width="56" height="56" viewBox="0 0 56 56" fill="none">
      ...
      <section className={cl(styles.section, styles.sectionAlliesGallery)}>
        <ArtTitle className={styles.artTitle} type='down'>Members</ArtTitle>
